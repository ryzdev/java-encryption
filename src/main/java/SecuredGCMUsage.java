...
public class SecuredGCMUsage {
    ...
    public void doEncryption(String messageToEncrypt) {
    ...
    private static byte[] aesEncrypt(String message, SecretKey aesKey, GCMParameterSpec gcmParamSpec, byte[] aadData) {
        Cipher c = null;
